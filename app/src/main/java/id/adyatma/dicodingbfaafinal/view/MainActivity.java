...
import id.adyatma.dicodingbfaafinal.adapter.UserListAdapter;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.language:
                ...
                Intent aIntent = new Intent(MainActivity.this, SettingsActivity.class);
                startActivity(aIntent);
                return true;

            case R.id.favorite:
                Intent bIntent = new Intent(MainActivity.this, FavoriteActivity.class);
